                ...
                <div class="row">
                    ...
                    @if(session('success'))
                        ...
                        @if ($errors->any())
                            ...
                            @endif
                            <form method="post" class="was-validated"  action="{{route('profile.update',['id'=>$id])}}">
                            @csrf
                            <div class="form-group">
                                <label style="margin-top: 30px;" for="name">Enter employee full name:</label>
                                <input class="form-control"  type="text" name="name" value="{{$profile->value('name')}}" required>
                            </div>
                            <div class="form-group">
                                <label for="email">Enter employee email:</label>
                                <input class="form-control"  type="email" name="email" value="{{$profile->value('email')}}" required>
                            </div>
                            <div class="form-group">
                                <label for="user_name">Enter employee username:</label>
                                <input class="form-control"  type="text" name="user_name" value="{{$profile->value('user_name')}}" required>
                            </div>
                            <div class="form-group">
                                <label for="brand_name">Enter employee telephone number:</label>
                                <input class="form-control"   type="text" name="telephone" value="{{$profile->value('telephone')}}" required>
                            </div>
